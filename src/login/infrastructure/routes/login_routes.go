// Eventos-Api-Go/src/login/infrastructure/routes/login_routes.go
package routes
...
func (router *LoginRouter) Run() {
    loginController, createController, getUserController, getAllUsersController, updateController, deleteController := infrastructure.InitUserDependencies()
    ...
    authGroup := router.engine.Group("/auth")
    {
        ...
        authGroup.GET("/users", getAllUsersController.Run)        
